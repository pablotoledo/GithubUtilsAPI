...
class GithubUtilsApi:
    ...
    def __init__(
        ...
        github_url_graphql="https://github.com/api/graphql",
        proxies=None,
        verify=True,
    ):
        """
        ...
        self.__user = user
        self.__token = token
        self.__auth = "Basic " + str(
            base64.b64encode(str(self.__user + ":" + token).encode("ascii")), "utf-8"
        )
    ...
    def _parse_github_error_message(self, json_response: dict) -> str:
        ...
        error_messages = [
            f"Error {index + 1}: {x.get('message')}"
            for index, x in enumerate(error_list)
        ]
        return ".\n".join(error_messages)
    ...
    def repository_org_create(
        self, organization_name=None, repository_name=None, visibility="private"
    ):
        """
    ...
    def team_create(
        self, organization_name=None, team_slug_name=None, team_privacy="closed"
    ):
        """
    ...
    def team_remove_user(
        self, organization_name=None, team_slug_name=None, github_username=None
    ):
        """
    ...
    def team_discussion_create(
        ...
        :return: request
        """
        body = {"title": discussion_title, "body": discussion_title, "private": private}
        url = (
            self.github_url
            + "/orgs/"
            + organization_name
    ...
    def team_discussion_search(
        ...
        discussions = self.team_discussion_list(
            organization_name, team_slug_name, page=index
        )
        ...
        if create_if_not_exists:
            return json.loads(
                self.team_discussion_create(
                    organization_name, team_slug_name, discussion_title, private
                ).text
            )

    def team_discussion_list(
        self, organization_name=None, team_slug_name=None, per_page=30, page=1
    ):
        """
    ...
    def team_discussion_create_comment(
        self,
        organization_name=None,
        team_slug_name=None,
    ...
    def list_repositories(
        self, organization_name=None, type="all", sort="created", per_page=30, page=1
    ):
        """
    ...
    def list_repositories_all(
        self, organization_name=None, repository_type="all", sort="created", per_page=30
    ):
        """
    ...
    def repository_branch_delete(
        self, owner=None, repository_name=None, branch_name=None
    ):
        """
    ...
    def list_repository_branches(
        self, owner=None, repository_name=None, protected=None, per_page=30, page=1
    ):
        """
    ...
    def list_repository_branches_all(
        self, owner=None, repository_name=None, protected=None, per_page=30
    ):
        """
        DEPRECATED!
    ...
    def recursive_get_all_repository_branches(
        self, organization_name, repository_name, page=1
    ):
        """
        ...
        if len(list_branches) == page_size:
            list_branches = list_branches + self.recursive_get_all_repository_branches(
                organization_name, repository_name, page + 1
            )
        else:
    ...
    def repository_get_commit_details(
        self, owner, repository_name, reference, per_page=30, page=1
    ):
        """
    ...
    def list_repository_teams(
        self, owner=None, repository_name=None, per_page=30, page=1
    ):
        """
    ...
    def list_teams_all(self, owner=None, per_page=30):
        ...
        page = 1
        result = self._response_to_json(
            self.list_teams(owner=owner, per_page=per_page, page=page)
        )
        result_all = []
        while len(result) > 0:
            page += 1
    ...
    def list_repository_prs(
        self, owner=None, repository_name=None, per_page=30, page=1, state="all"
    ):
        """
    ...
    def list_repository_prs_all(
        self, owner=None, repository_name=None, per_page=30, state="all"
    ):
        """
    ...
    def list_repository_collaborations(
        self,
        owner=None,
        repository_name=None,
        permission=None,
    ...
    def list_repository_colllaborations_all(
        self,
        owner=None,
        repository_name=None,
        permission=None,
        ...
        page = 1
        result = self._response_to_json(
            self.list_repository_collaborations(
                owner=owner,
                repository_name=repository_name,
    ...
    def list_commit_statuses(
        self, owner=None, repo=None, sha=None, per_page=30, page=1
    ):
        """
    ...
    def list_commit_statuses_all(self, owner=None, repo=None, sha=None, per_page=30):
        ...
        page = 1
        result = self._response_to_json(
            self.list_commit_statuses(
                owner=owner, repo=repo, sha=sha, per_page=per_page, page=page
            )
        )
        result_all = []
        while len(result) > 0:
    ...
    def list_reviews_for_pr(
        self, owner=None, repo=None, pull_number=None, per_page=30, page=1
    ):
        """
    ...
    def list_reviews_for_pr_all(
        self, owner=None, repo=None, pull_number=None, per_page=30
    ):
        """
        This method allows listing all statuses check in a specific reference , without paginate option using the method self.list_commit_statuses.
        According API docs: https://docs.github.com/en/rest/pulls/reviews?apiVersion=2022-11-28#list-reviews-for-a-pull-request
    ...
    def organization_members_list_all(self, owner=None, per_page=30):
        ...
        result = self._response_to_json(
            self.organization_members_list(
                organization_name=owner, per_page=per_page, page=page
            )
        )
        result_all = []
        while len(result) > 0:
    ...
    def list_repos_for_a_user(
        self, username=None, type="all", direction="asc", per_page=30, page=1
    ):
        """
    ...
    def list_repos_for_a_user_all(
        self, username=None, type="all", direction="asc", per_page=30
    ):
        """
    ...
    def list_review_comments_on_a_pr(
        self,
        owner=None,
        repo=None,
        pull_number=None,
    ...
    def list_review_comments_on_a_pr_all(
        self, owner=None, repo=None, pull_number=None, direction="asc", per_page=30
    ):
        """
        ...
        page = 1
        result = self._response_to_json(
            self.list_review_comments_on_a_pr(
                owner=owner,
                repo=repo,
                pull_number=pull_number,
                direction=direction,
    ...
    def delete_repository_branch_protection_rule(
        self, repository_rule: dict
    ) -> requests.Response:
        """
        ...
        query = query.replace(
            "change_branchProtectionRuleId", str(repository_rule["id"])
        )
        query = query.replace("'", '"')
        myjson = {"query": query}

        return self._request(
            "POST", self.github_url_graphql, data=myjson, is_graphql=True
        )
    ...
    def create_repository_branch_protection_rule_by_template(
        self, rule_template, repo_github
    ):
        """
        ...
        query = query.replace(
            "change_allowsForcePushes", str(allows_force_pushes).lower()
        )
        ...
        bypass_force_push_actor_ids = self._get_ids_branch_protection(
            rule_template["bypassForcePushAllowances"],
            rule_template["bypassForcePushAllowances"],
        )  # IDs list
        query = query.replace(
            "change_bypassForcePushActorIds", str(bypass_force_push_actor_ids)
        )

        bypass_pull_request_actor_ids = self._get_ids_branch_protection(
            rule_template["bypassPullRequestAllowances"],
            rule_template["bypassPullRequestAllowances"],
        )  # IDs list
        query = query.replace(
            "change_bypassPullRequestActorIds", str(bypass_pull_request_actor_ids)
        )
        ...
        push_actor_ids = self._get_ids_branch_protection(
            rule_template["pushAllowances"], rule_template["pushAllowances"]
        )  # IDs list
        ...
        query = query.replace(
            "change_dismissesStaleReviews", str(is_admin_enforced).lower()
        )

        required_approving_review_count = rule_template[
            "requiredApprovingReviewCount"
        ]  # int
        if required_approving_review_count is None:
            required_approving_review_count = 0
        query = query.replace(
            "change_requiredApprovingReviewCount",
            str(required_approving_review_count).lower(),
        )  # int

        requires_status_checks = rule_template["requiresStatusChecks"]  # Boolean
        query = query.replace(
            "change_requiresStatusChecks", str(requires_status_checks).lower()
        )  # int

        required_status_check_contexts = rule_template[
            "requiredStatusCheckContexts"
        ]  # [String!]
        query = query.replace(
            "change_requiredStatusCheckContexts", str(required_status_check_contexts)
        )

        requires_approving_reviews = rule_template[
            "requiresApprovingReviews"
        ]  # Boolean
        query = query.replace(
            "change_requiresApprovingReviews", str(requires_approving_reviews).lower()
        )

        requires_code_owner_reviews = rule_template[
            "requiresCodeOwnerReviews"
        ]  # Boolean
        query = query.replace(
            "change_requiresCodeOwnerReviews", str(requires_code_owner_reviews).lower()
        )

        requires_commit_signatures = rule_template[
            "requiresCommitSignatures"
        ]  # Boolean
        query = query.replace(
            "change_requiresCommitSignatures", str(requires_commit_signatures).lower()
        )

        requires_conversation_resolution = rule_template[
            "requiresConversationResolution"
        ]  # Boolean
        query = query.replace(
            "change_requiresConversationResolution",
            str(requires_conversation_resolution).lower(),
        )

        requires_linear_history = rule_template["requiresLinearHistory"]  # Boolean
        query = query.replace(
            "change_requiresLinearHistory", str(requires_linear_history).lower()
        )

        requires_strict_status_checks = rule_template[
            "requiresStrictStatusChecks"
        ]  # Boolean
        query = query.replace(
            "change_requiresStrictStatusChecks",
            str(requires_strict_status_checks).lower(),
        )
        ...
        restricts_review_dismissals_pushes = rule_template[
            "restrictsReviewDismissals"
        ]  # Boolean
        query = query.replace(
            "change_restrictsReviewDismissals",
            str(restricts_review_dismissals_pushes).lower(),
        )

        review_dismissal_actor_ids = self._get_ids_branch_protection(
            rule_template["reviewDismissalAllowances"],
            rule_template["reviewDismissalAllowances"],
        )  # IDs list
        query = query.replace(
            "change_reviewDismissalActorIds", str(review_dismissal_actor_ids)
        )
        query = query.replace("'", '"')

        myjson = {"query": query}

        return self._response_to_json(
            self._request("POST", self.github_url_graphql, data=myjson, is_graphql=True)
        )

    def update_required_status_check_context_to_branch_policy(
        self, branch_protection_rule_id, status_check_contexts: list
    ):
        """
        ...
        required_status_checks = ",".join(
            ["{context: " + f'"{x}"' + "}" for x in status_check_contexts]
        )
        required_status_checks = "[" + required_status_checks + "]"
        query = query.replace(
            "change_branchProtectionRuleId", branch_protection_rule_id
        )
        query = query.replace(
            "change_requiredStatusCheckContexts",
            str(status_check_contexts).replace("'", '"'),
        )
    ...
    def change_branch_regex_pattern_policies(
        self, branch_protection_rule_id, new_pattern
    ):
        """
    ...
    def repository_create_hook(
        self, organization_name: str, repository_name: str, hook_payload: dict
    ):
        """
    ...
    def repository_create_branch(
        ...
        data = {"ref": branch_name, "sha": commit_id}
